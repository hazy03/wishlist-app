...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'font-medium rounded-soft transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]';
